...
Реализованы ввод данных с клавиатуры и вывод данных на дисплей. Комментарии в программе присутствуют. Тесты программы присутствуют в папке [tests](docs/README.md).
