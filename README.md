...
За счет передачи аргументов подпрограмм через стек они поддерживают многократное использование и позволяют подключать другие массивы, что проиллюстрировано в тестовой программе. Отдельная тестовая программа создана, [ниже](https://github.com/makar-with-tea/makar-with-tea-CSA-IHW1/edit/main/README.md#%D1%82%D0%B5%D1%81%D1%82%D1%8B) приведен скриншот ее выполнения.
